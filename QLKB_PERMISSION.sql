...
GRANT SELECT (DoctorID, DoctorName, Gender, DoctorBirthdate, DateJoined, Specialization, Department, DoctorPhone, DoctorEmail) ON qlkb.Doctor TO patient_role;
...
GRANT SELECT (LabPhysID, LabPhysName, Gender, LabPhysBirthdate, DateJoined, Specialization, LabPhysPhone, LabPhysEmail) ON qlkb.LaboratoryPhysician TO doctor_role;
...
GRANT SELECT (PatientID, CitizenID, PatientName, Gender, PatientBirthdate, PatientPhone, PatientEmail, PatientAddr, EmergencyContact) ON qlkb.Patient TO doctor_role;
...
GRANT SELECT (DoctorID, DoctorName, Gender, DoctorBirthdate, DateJoined, Specialization, Department, DoctorPhone, DoctorEmail) ON qlkb.Doctor TO receptionist_role;
...
GRANT SELECT (DoctorID, DoctorName, Gender, DoctorBirthdate, DateJoined, Specialization, Department, DoctorPhone, DoctorEmail) ON qlkb.Doctor TO labphysician_role;
...
GRANT SELECT (PatientID, CitizenID, PatientName, Gender, PatientBirthdate, PatientPhone, PatientEmail, PatientAddr, EmergencyContact) ON qlkb.Patient TO labphysician_role;
